...
@Controller
public class RegistroIncidenciasController {
    ...
    @GetMapping("/registrarIncidencias")
    public String mostrarPartidosParaRegistrarIncidencias(
        ...
        return "vistas/miembroMesa/registrarIncidencias";
    }


    // Mostrar formulario de registro de incidencias + listar incidencias existentes
    @GetMapping("/guardarIncidencias")
    public String mostrarFormularioIncidencia(
        ...
        return "vistas/miembroMesa/guardarIncidencias";
    }
    ...
    public String registrarIncidencia(
        ...
        return "redirect:/guardarIncidencias?partidoId=" + partidoId;
    }
}
