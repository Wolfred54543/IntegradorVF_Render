...
public class RegistrarResultadosController {
    ...
    @GetMapping("/registrarResultados")
    public String mostrarPartidosParaRegistrarResultados(
        ...
        return "vistas/miembroMesa/registrarResultados"; // Ruta de la vista para registrar resultados en miembroMesa
    }
    
    @GetMapping("/guardarResultados")
    public String mostrarGuardarResultados(@RequestParam Long partidoId, Model model) {
        ...
        return "vistas/miembroMesa/guardarResultados"; // Redirecciona a la vista para guardar resultados
    }
    ...
    public String guardarResultados(@RequestParam Long partidoId,
        ...
        return "redirect:/registrarResultados";
    }
    ...
    public String mostrarTablaPosiciones(@RequestParam Long campeonatoId, Model model) {
        ...
        return "vistas/miembroMesa/tablaPosiciones";
    }
