...
public class JugadorService {
    ...
    // Obtener equipos por año sin contar el mes
    ...
    public List<Jugador> getJugadoresPorEquipo(Long equipoId) {
        return jugadorRepository.findByEquipoEquId(equipoId);
    }

    //Paginador de la vista de los jugadores
    public Page<Jugador> listarTodosPaginados(Pageable pageable) {
        return jugadorRepository.findAll(pageable);
    }

    //Buscador de la vista de los jugadores
    public Page<Jugador> buscarPorNombreApellidoODni(String filtro, Pageable pageable) {
        return jugadorRepository.buscarPorNombreApellidoDni(filtro, pageable);
    }
